...
def staff_home(request):
    ...
    context = {
        'page_title': 'Bảng điều khiển cho Giảng viên - ' + str(staff.admin.last_name) + ' (' + str(staff.course) + ')',
...
def staff_apply_leave(request):
    ...
    context = {
        ...
        'page_title': 'Chấp Thuận Nghỉ Phép'
    }
...
def staff_view_profile(request):
    ...
    context = {'form': form, 'page_title': 'Xem/Sửa Hồ Sơ'}
    if request.method == 'POST':
        try:
            if form.is_valid():
                ...
                messages.error(request, "Lỗi Khi Cập Nhật Hồ Sơ")
                return render(request, "staff_template/staff_view_profile.html", context)
        except Exception as e:
            messages.error(
                request, "Lỗi Khi Cập Nhật Hồ Sơ: " + str(e))
            return render(request, "staff_template/staff_view_profile.html", context)
